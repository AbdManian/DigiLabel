...
import argparse
import pagesizes
from labelmerger import do_label_mergs
...
def build_label_print_size(args):
    ...
    label_page = pagesizes.PageSize(args.LabelPageHeight, args.LabelPageWidth, label_margins)
    ...
    print_page = pagesizes.PageSize(args.PrintHeight, args.PrintWidth, print_margins)
...
def main():
    ...
    do_label_mergs(user_args.outputfile, user_args.labels, page_sizes)
